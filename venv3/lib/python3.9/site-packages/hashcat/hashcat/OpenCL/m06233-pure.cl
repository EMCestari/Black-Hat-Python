...
KERNEL_FQ void m06233_comp (KERN_ATTR_TMPS_ESALT (tc_tmp_t, tc_t))
{
  ...
  ukey5[1] = hc_swap32_S (tmps[gid].out[33]);
  ukey5[2] = hc_swap32_S (tmps[gid].out[34]);
  ukey5[3] = hc_swap32_S (tmps[gid].out[35]);
  ukey5[4] = hc_swap32_S (tmps[gid].out[36]);
  ukey5[5] = hc_swap32_S (tmps[gid].out[37]);
  ukey5[6] = hc_swap32_S (tmps[gid].out[38]);
  ukey5[7] = hc_swap32_S (tmps[gid].out[39]);

  u32 ukey6[8];

  ukey6[0] = hc_swap32_S (tmps[gid].out[40]);
  ukey6[1] = hc_swap32_S (tmps[gid].out[41]);
  ukey6[2] = hc_swap32_S (tmps[gid].out[42]);
  ukey6[3] = hc_swap32_S (tmps[gid].out[43]);
  ukey6[4] = hc_swap32_S (tmps[gid].out[44]);
  ukey6[5] = hc_swap32_S (tmps[gid].out[45]);
